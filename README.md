...
***Первые 5 новых учасников группы [Akash_RU](https://t.me/akash_ru) ,  кто установит Akashlitics и создаст аккаунт - получат по 7 АКТ для запуска ноды валидатора Paloma. Просто отправьте в чат скрин из [Akashlytics](https://www.akashlytics.com/deploy) и ваш адрес AKT.***

Пример:

![image](https://user-images.githubusercontent.com/23629420/174968988-b30fa8ae-92c5-40e4-9d80-59ef396be016.png)

При наличии выделенных токенов ```GRAIN```, участникам указавшим в моникере "***Akash***" (например: Dimokus_Akash)  будут перечислены дополнительные токены тестовой сети.
